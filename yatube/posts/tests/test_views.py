...
class PostViewsTests(TestCase):
    ...
    def test_pages_uses_correct_template(self):
        ...
        templates_page_names = {
            ...
            reverse('posts:group_list',
                    kwargs={'slug':
                            f'{PostViewsTests.group.slug}'}): 'posts/group_list.html',
    ...
    def test_group_list_shows_correct_context(self):
        ...
        post_text_0 = {response.context['group'].title: 'Тестовая группа',
    ...
    def test_profile_shows_correct_context(self):
        ...
        self.assertEqual(response.context['author'].username, self.user.username,
                        f'Ошибка: шаблон сформирован с неправильным контекстом')
    ...
    def test_post_another_group_conflict(self):
        ...
        self.assertIn(self.post, response_index.context['page_obj'],
                     f'Ошибка: тестового поста нет на главной странице')
        self.assertIn(self.post, response_group.context['page_obj'],
                     f'Ошибка: тестового поста нет в группе')
        self.assertIn(self.post, response_profile.context['page_obj'],
                     f'Ошибка: тестового поста нет в профиле пользователя')
...
class PaginatorViewsTest(TestCase):
    ...
    def setUp(self):
        ...
        for i in range(QUANTITY_OF_POSTS):
            posts.append(Post(text=f'Тестовый пост {i}',
                                  group=self.group,
                                  author=self.user))
    ...
    def test_first_page_contains_ten_records(self):
        ...
        for page in pages:
            ...
            self.assertEqual(len(response.context['page_obj']),
                            QUANTITY_OF_POSTS,
                            f'Ошибка:неверное количество постов.'
                )
